	...
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main mag0">
				...
				<%-- <ul class="layui-nav mobileTopLevelMenus" mobile>
					<li class="layui-nav-item" data-menu="contentManagement">
						<a href="javascript:;"><i class="seraph icon-caidan"></i><cite>HMS</cite></a>
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;"><img src="${ctx}/images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">用戶XXX</cite></a>
						<dl class="layui-nav-child">
							<%-- <dd><a href="javascript:;" data-url="${ctx }/system/userInfo"><i class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd> --%>
							<dd><a href="javascript:;" <%-- data-url="${ctx }/system/updatePwd" --%> class="updatePwd"><i class="seraph icon-xiugai" data-icon="icon-xiugai"></i><cite>修改密码</cite></a></dd>
							<%-- <dd><a href="javascript:;" class="showNotice"><i class="layui-icon">&#xe645;</i><cite>系统公告</cite><span class="layui-badge-dot"></span></a></dd>
							<dd pc><a href="javascript:;" class="functionSetting"><i class="layui-icon">&#xe620;</i><cite>功能设定</cite><span class="layui-badge-dot"></span></a></dd> --%>
							<%-- <dd pc><a href="javascript:;" class="changeSkin"><i class="layui-icon">&#xe61b;</i><cite>更换皮肤</cite></a></dd> --%>
							<dd><a href="${ctx}/system/logout" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="${ctx}/images/face.jpg" class="userAvatar"></a>
