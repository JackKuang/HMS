...
public class DateUtils {
    ...
    public static String formatYearMonth(Date date){
        String result = "";
        if (date != null) {
            result = DateFormatUtils.format(date,PATTERN_YEARMONTH);
        }
        return result;
    }
    ...
    public static Date parseYear(String str){
        ...
        if (str != null && !"".equals(str)) {
            try {
                result = org.apache.commons.lang.time.DateUtils.parseDate(str,new String[] { PATTERN_YEAR });
    ...
    public static Date parseYearMonth(String str){
        ...
        if (str != null && !"".equals(str)) {
            try {
                result = org.apache.commons.lang.time.DateUtils.parseDate(str,new String[] { PATTERN_YEARMONTH });
            } catch (ParseException e) {
                // e.printStackTrace();
            }
        }
    ...
    public static Date parseDate(String str){
        ...
        if (str != null && !"".equals(str)) {
            try {
                result = org.apache.commons.lang.time.DateUtils.parseDate(str,new String[] { PATTERN_DATE });
            } catch (ParseException e) {
                // e.printStackTrace();
            }
        }
    ...
    public static Date parseDateTime(String str){
        ...
        if (str != null && !"".equals(str)) {
            try {
                result = org.apache.commons.lang.time.DateUtils.parseDate(str,new String[] { PATTERN_DATETIME });
            } catch (ParseException e) {
                // e.printStackTrace();
            }
        }
    ...
    public static Date parseDateTimess(String str){
        ...
        if (str != null && !"".equals(str)) {
            try {
                result = org.apache.commons.lang.time.DateUtils.parseDate(str,new String[] { PATTERN_DATETIMESS });
            } catch (ParseException e) {
                // e.printStackTrace();
            }
        }
    ...
    public static Date parseTime(String str){
        ...
        if (str != null && !"".equals(str)) {
            try {
                result = org.apache.commons.lang.time.DateUtils.parseDate(str,new String[] { PATTERN_HHMM });
            } catch (ParseException e) {
                // e.printStackTrace();
            }
        }
    ...
    public static int getAgeByBirthday(Date birthday,Date currentDate){
        int age = 0;
        if (birthday != null) {
            age = Integer.parseInt(formatYear(currentDate)) - Integer.parseInt(formatYear(birthday));
    ...
    public boolean isValidDate(String dateStr,String format){
        ...
        if (dateStr == null || format == null || dateStr.isEmpty() || format.isEmpty()) {
            return false;
        } else {
            try {
    ...
    public static int intevalBetweenDate(String start,String end){
        int inteval = 0;
        if (StringUtils.isNotEmpty(start) && start.length() >= 7 && StringUtils.isNotEmpty(end) && end.length() >= 7) {
    ...
    /**
     * @Description: 获取时间差距计算，date1-date2
     * @Author: JackKuang
     * @Since: 2018年1月21日下午11:15:19
     * @param date1 开始时间
     * @param date2 结束时间
     * @param field 时间比较参数，结合Calendar里的参数，例如，YEAR,MONTH等
     * @return
     */
